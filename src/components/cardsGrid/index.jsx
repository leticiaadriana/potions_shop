...
function StaticCard({ image, name, price, onClick }) {
  const cardStyle = {
...
function HomeGrid() {
  ...
  // IDs das poções no banco de dados
  const pocoesDestaque = [
    { id: 1, image: "https://i.ibb.co/pyhZJXf/rsz-lilas.png", name: "Poção do Perfume Misterioso", price: 200 },
    { id: 2, image: "https://i.ibb.co/ZzS7xb2/rsz-sky.png", name: "Poção Blue Sky", price: 300 },
    { id: 3, image: "https://i.ibb.co/DkzdL1q/rsz-pinus.png", name: "Poção de Pinus", price: 3000 },
  ];
